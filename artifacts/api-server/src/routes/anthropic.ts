...
router.post("/anthropic/conversations/:id/messages", async (req, res): Promise<void> => {
  try {
    ...
    const systemPrompt = [
      ...
      "• Payout multipliers (exact): Power 2=3× | 3=6× | 4=10× | 5=20× | 6=40×",
      "  Flex 3-pick: 3/3=5× 2/3=1.25× | 4-pick: 4/4=10× 3/4=2.5× | 5-pick: 5/5=20× 4/5=4× 3/5=1×",
      "  Flex 6-pick: 6/6=40× 5/6=6× 4/6=1.5× 3/6=1×",
      "• Break-even P per leg — Power: P2=57.7% | P3=55.0% | P4=56.2% | P5=54.9% | P6=54.1%",
      "  Break-even P per leg — Flex: 5-pick=43.8% | 6-pick=41.8% (lower than Power due to partial-credit payouts)",
