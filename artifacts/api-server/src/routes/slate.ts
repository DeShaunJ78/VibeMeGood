  ...
  try {
    ...
    const rows = lines.map(line => {
      ...
      return {
        ...
        minutesAvg: (score?.reasoning as Record<string, unknown> | null)?.minutesAvg as number | null ?? null,
        minutesStdDev: (score?.reasoning as Record<string, unknown> | null)?.minutesStdDev as number | null ?? null,
        roleStability: (score?.reasoning as Record<string, unknown> | null)?.roleStability as string | null ?? null,
