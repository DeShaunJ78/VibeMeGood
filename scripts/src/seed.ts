...
async function seed() {
  ...
  const playerDefs = [
    ...
    // MLB starting pitchers — needed so the projection engine can load pitcher game
    // logs and fire strikeoutMatchupFactor / pitcherFormFactor for batter props.
    { sport: "MLB", fullName: "Tyler Glasnow",    firstName: "Tyler",    lastName: "Glasnow",  teamId: teamsByAbbr["LAD"].id, position: "SP", status: "active" },
    { sport: "MLB", fullName: "Walker Buehler",   firstName: "Walker",   lastName: "Buehler",  teamId: teamsByAbbr["LAD"].id, position: "SP", status: "active" },
    { sport: "MLB", fullName: "Bobby Miller",     firstName: "Bobby",    lastName: "Miller",   teamId: teamsByAbbr["LAD"].id, position: "SP", status: "active" },
    { sport: "MLB", fullName: "Gerrit Cole",      firstName: "Gerrit",   lastName: "Cole",     teamId: teamsByAbbr["NYY"].id, position: "SP", status: "active" },
    { sport: "MLB", fullName: "Carlos Rodon",     firstName: "Carlos",   lastName: "Rodon",    teamId: teamsByAbbr["NYY"].id, position: "SP", status: "active" },
    { sport: "MLB", fullName: "Framber Valdez",   firstName: "Framber",  lastName: "Valdez",   teamId: teamsByAbbr["HOU"].id, position: "SP", status: "active" },
    { sport: "MLB", fullName: "Hunter Brown",     firstName: "Hunter",   lastName: "Brown",    teamId: teamsByAbbr["HOU"].id, position: "SP", status: "active" },
